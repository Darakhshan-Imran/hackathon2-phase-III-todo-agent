    ...
    return (
        <div className="flex items-center justify-center min-h-full w-full">
            <div className="space-y-4 w-auto">
                <div className="ml-2 flex items-center space-x-2 text-violet-400 font-medium">
                    <LoadingAnimation
                ...
                <div className="relative">
                    ...
                    >
                        <div>
                            {visibleLines.map((line, index) => (
                                ...
                                >
                                    <div className="text-violet-400/40 pr-3 select-none w-6 text-right">
                                        {line.number}
                                    </div>

                                    <div className="text-white/80 flex-1 ml-1">
                                        {line.text}
                                    </div>
                                </div>
                            ))}
                    ...
                    <div
                        ...
                        style={{
                            background:
                                "linear-gradient(to bottom, rgba(10, 10, 11, 0.9) 0%, rgba(10, 10, 11, 0.5) 30%, transparent 100%)",
                        }}
                    />
                </div>
            </div>
